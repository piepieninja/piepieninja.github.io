...
\headedsection  % sets the header for the section and includes any subsections
  ...
  \headedsubsection
    ...
    {\bodytext{Co-wrote proposals and Co-founded the SSRL. I run day to day operations and research.}}
  \headedsubsection
    {Multiview Onboard Computational Imager (MOCI) Satellite}
    {January \apo16 -- present}
    {\bodytext{A 6U cube satellite based using Nvidia TX2i GPU/SoC to Generate 3D digital surface models.}}
  \headedsubsection
    {Spectral Ocean Color (SPOC) Satellite}
    {January \apo16 -- present}
    {\bodytext{A 3U cube satellite with a custom hyperspectral sensor to analyze the coastal ecosystems of Georgia.}}
}
...
\headedsection  % sets the header for a subsection and contains usually body text
  ...
  \headedsubsection
    ...
    {\bodytext{I helped audio telemetry and communication for the Orion spacecraft.}}
  \headedsubsection
    {Human Systems Integration}
    {April \apo15 -- August \apo15}
    {\bodytext{Helped develop future Graphic User Interfaces (GUIs) used for training astronauts.}}
}
...
\headedsection  % sets the header for a subsection and contains usually body text
  ...
  %   {\bodytext{I assisted Dr. Johnson Turner with technical advice and programmed/designed environments for digital music systems.}}
   \headedsubsection
    ...
    {August \apo14 -- April \apo15}
    {\bodytext{Helped develop first \href{https://github.com/piepieninja/gdkscoreviewer}{musical score viewing application} for Google Glass}}
  \headedsubsection
    {Smart Podium Development}
    {August \apo14 -- April \apo15}
    {\bodytext{Developed smart podium for the band director to synchronized music editing and notation.}}
}
...
\headedsection  % sets the header for a subsection and contains usually body text
  ...
  \headedsubsection
    ...
    {April \apo14 -- August \apo14}
    {\bodytext{Developed AR applications for improved store support services.}}
  \headedsubsection
    {Virtual Reality Research \& Development}
    {April \apo14 -- August \apo14}
    {\bodytext{Developed a VR to display heat maps of data over store shelves.}}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{center}
  \emph{\small This is an incomplete list, you can visit my \href{http://calebadams.space}{website}, or click the links above, for more details on my research}
\end{center}
