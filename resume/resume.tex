...
\headedsection  % sets the header for the section and includes any subsections
  ...
  \headedsubsection
    {Multiagent Surface Reconstruction}
    {January \apo18 -- present}
    {\bodytext{My Masters research is focused on effective methods for satellites swarms to generate 3D models of environments. The focus is on distributed edge computing with custom GPU/SoCs running custom computer vision software. Orbital environments are simulated with high performance graphics hardware and reconstructed with a network of custom GPU/SoCs for cube satellites.}}
}
...
\headedsection
  ...
  \headedsubsection
    ...
    {2019}
    {\bodytext{I am helping to organize the 3rd Space Innovations Symposium in Atlanta Georgia at Georgia Tech, where I chaired a session of the symposium. I also helped with getting students and organizations in the Athens area to attend the symposium.}}
}
