...
\headedsection  % sets the header for the section and includes any subsections
  ...
  \headedsubsection
    {Ms Thesis: High Performance Computation with Small Satellites and \\Small Satellite Swarms for 3D Reconstruction}
...
\headedsection
  {{\color{bluegreen} \faFileTextO} \href{}{High Performance Computation with Small Satellites and Small Satellite Swarms for 3D Reconstruction}{%
  \headedsubsection
