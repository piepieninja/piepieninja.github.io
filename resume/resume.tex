...
\noindent\hspace*{0pt}Curriculum Vitae
...
\headedsection  % sets the header for the section and includes any subsections
  ...
  \headedsubsection
    {Project Manager, Distributed Spacecraft Autonomy (DSA)}
    {July \apo20 -- present}
    {\bodytext{The DSA project will advance command and control methodologies for controlling a swarm of spacecraft as a single entity, demonstrate autonomous coordination between multiple spacecraft in the swarm, and demonstrate approaches for adaptive reconfiguration of the swarm’s plan and distributed decision-making across a swarm of spacecraft. DSA has performed several on-orbit tests to date and will fly as a payload onboard NASA's Starling 1.0 swarm mission.}}
  \headedsubsection
    {Principal Investigator, Neural Radiance Methods}
    {October \apo22 -- present}
    {\bodytext{ The Neural Radiance Methods research project seeks to study potential improvements to traditional photogrammetric methods used to generate Digital Elevation Models of planetary surfaces by utilizing Neural Radiance Fields. }}
  \headedsubsection
...
\headedsection  % sets the header for a subsection and contains usually body text
  {\href{http://nasa.gov}{NASA Johnson Space Center, National Aeronautics and Space Administration }}
  {\textsc{Houston, TX}} {%
  \headedsubsection
...
\headedsection
  {{\color{bluegreen} \faTelevision} \href{\#}{An Overview of Distributed Spacecraft Autonomy}}{%
  \headedsubsection
    {3rd SMD and ETD Workshop on AI and Data Science}
    {Greenbelt MD, 2023}
    {\bodytext{Caleb Adams, Jeremy Frank}}
}

\headedsection
  {{\color{bluegreen} \faTelevision} \href{\#}{An Overview of Distributed Spacecraft Autonomy}}{%
  \headedsubsection
    {JPL Center for Autonomy}
    {Pasadena CA, 2023}
    {\bodytext{Caleb Adams, Jeremy Frank}}
}
...
\headedsection
  ...
  \headedsubsection
    ...
    {Big Sky MT, 2023}
    {\bodytext{Caleb Adams, Brian Kempa, Walter Vaughan, Nicholas Cramer}}
}
...
\headedsection
  ...
  \headedsubsection
    ...
    {Pasadena CA, 2023}
    {\bodytext{Walter Vaughan, Caleb Adams, Sergei Gridnev, Nick Cramer, Alice Anlind, Eric Brune, Oskar Flordal, Fredrik Bruhn, Alan George}}
}
...
% Awarded via competitive selection for a Center Innovation Fund.
...
\headedsection
  ...
  \headedsubsection
    ...
    {2022}
    {\bodytext{NASA Ames internal funding awarded via competitive selection.}}
}
...
\headedsection
  ...
  {%
  \headedsubsection
    {University Nanosatellite Program, Nano-Sat 9 Phase A}
    {2016}
...
\headedsection
  ...
  {%
  \headedsubsection
    {Best Paper Track 5: Observation Systems and Technologies}
    {2021}
    {\bodytext{I received the Best Paper award for Track 5: Observation Systems
    and Technologies for \href{https://ieeexplore.ieee.org/abstract/document/9438159}{my paper on 3D reconstruction using small satellites}.}}
}
...
\headedsection
  ...
  \headedsubsection
    {Project Manager}
    {2023 -- present}
    {\bodytext{I manage NASA's SBIR/STTR program for Neuromrophic Computing}}
}
...
\headedsection
  ...
  \headedsubsection
    {Project Manager}
    {2022 -- present}
    {\bodytext{I manage and direct a group of developers, engineers, researchers, and interns. Work directly with NASA HQ and Ames Leadership to meet milestones and deliverables.}}
}

\headedsection
  {{Neural Radiance Methods}}
  {\textsc{Mountain View, CA}} {%
  \headedsubsection
    {Principal Investigator}
    {2022 -- present}
    {\bodytext{I manage and direct a small group of interns and researchers.}}
}
